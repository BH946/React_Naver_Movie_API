...
**해당 내용에서 핵심은** https://cors-anywhere.herokuapp.com 들어가면 

![image-20220714170642851](/images/README/image-20220714170755459.png)

이런 demo 서버 접근 요청 버튼이 있다. 클릭하고 나면 해당 프록시서버 이용할 수 있으니 이부분은 꼭 체크하고 넘어가길 바란다.(속도도 일부러 느리게 관리자가 바꾸셨다, 평생 사용할 수 있는게 아니므로 문제있으면 다시 이사이트 들어가서 demo 서버 접근 요청 버튼 클릭해야한다)
